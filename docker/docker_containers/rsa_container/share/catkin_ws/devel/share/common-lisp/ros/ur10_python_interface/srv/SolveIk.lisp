...
(cl:in-package ur10_python_interface-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SolveIk-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SolveIk-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur10_python_interface-srv:<SolveIk-request> is deprecated: use ur10_python_interface-srv:SolveIk-request instead.")))

(cl:ensure-generic-function 'end_pose-val :lambda-list '(m))
(cl:defmethod end_pose-val ((m <SolveIk-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-srv:end_pose-val is deprecated.  Use ur10_python_interface-srv:end_pose instead.")
  (end_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SolveIk-request>)))
  ...
  "ur10_python_interface/SolveIkRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SolveIk-request)))
  "Returns string type for a service object of type 'SolveIk-request"
  "ur10_python_interface/SolveIkRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SolveIk-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SolveIk-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur10_python_interface-srv:<SolveIk-response> is deprecated: use ur10_python_interface-srv:SolveIk-response instead.")))

(cl:ensure-generic-function 'ik_result-val :lambda-list '(m))
(cl:defmethod ik_result-val ((m <SolveIk-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-srv:ik_result-val is deprecated.  Use ur10_python_interface-srv:ik_result instead.")
  (ik_result m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SolveIk-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-srv:success-val is deprecated.  Use ur10_python_interface-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SolveIk-response>)))
  ...
  "ur10_python_interface/SolveIkResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SolveIk-response)))
  "Returns string type for a service object of type 'SolveIk-response"
  "ur10_python_interface/SolveIkResponse")
