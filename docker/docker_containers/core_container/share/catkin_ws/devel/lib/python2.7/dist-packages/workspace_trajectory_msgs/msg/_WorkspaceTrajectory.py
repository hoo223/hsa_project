...
"""autogenerated by genpy from workspace_trajectory_msgs/WorkspaceTrajectory.msg. Do not edit."""
import codecs
import sys
...
class WorkspaceTrajectory(genpy.Message):
  _md5sum = "fe85e09bed1ee10e23a32888d54b9372"
  _type = "workspace_trajectory_msgs/WorkspaceTrajectory"
...
float64 y
float64 z"""
  __slots__ = ['name','waypoints','wrenches','timestamps']
  _slot_types = ['string','geometry_msgs/Pose[]','geometry_msgs/Wrench[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,waypoints,wrenches,timestamps
    ...
    """
    if args or kwds:
      super(WorkspaceTrajectory, self).__init__(*args, **kwds)
