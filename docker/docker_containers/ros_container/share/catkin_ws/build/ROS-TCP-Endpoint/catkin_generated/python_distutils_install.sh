...
echo_and_run cd "/root/share/catkin_ws/src/ROS-TCP-Endpoint"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/share/catkin_ws/src/ROS-TCP-Endpoint/setup.py" \
    egg_info --egg-base /root/share/catkin_ws/build/ROS-TCP-Endpoint \
    build --build-base "/root/share/catkin_ws/build/ROS-TCP-Endpoint" \
    install \
    --root="${DESTDIR-/}" \
