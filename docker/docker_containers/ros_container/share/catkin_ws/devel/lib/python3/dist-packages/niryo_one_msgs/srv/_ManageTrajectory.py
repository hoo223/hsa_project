...
class ManageTrajectoryRequest(genpy.Message):
  _md5sum = "0dc705c5e725b111171dfe277e46fb76"
...
class ManageTrajectoryResponse(genpy.Message):
  _md5sum = "214e58fb6a712d449c630ea1d32b6f3a"
    ...
    try:
      ...
      for val1 in self.trajectory.trajectory_plan.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v139.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.dimensions))
        length = len(_v139.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.primitive_poses:
          _v146 = val3.position
          _x = _v146
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v147
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v139.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(_get_struct_3I().pack(*val4.vertex_indices))
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v139.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.mesh_poses:
          _v148 = val3.position
          _x = _v148
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v149
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v139.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.planes:
          buff.write(_get_struct_4d().pack(*val3.coef))
        length = len(_v139.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.plane_poses:
          _v150 = val3.position
          _x = _v150
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v151
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v139.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v139.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v139.subframe_poses:
          _v152 = val3.position
          _x = _v152
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v154.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v154.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v154.points)
        buff.write(_struct_I.pack(length))
        for val3 in _v154.points:
          length = len(val3.positions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(struct.Struct(pattern).pack(*val3.positions))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v172.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v172.id = str[start:end]
        _v178 = _v172.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v178.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v178.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v178.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v178.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v172.primitives = []
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v172.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v172.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v179 = val3.position
          _x = _v179
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v172.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v172.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v172.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v172.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v172.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v172.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v185 = val3.position
          _x = _v185
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v172.subframe_poses.append(val3)
        start = end
        end += 1
        (_v172.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
    ...
    try:
      ...
      for val1 in self.trajectory.trajectory_plan.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v205.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.primitives:
          _x = val3.type
          buff.write(_get_struct_B().pack(_x))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v205.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.primitive_poses:
          _v212 = val3.position
          _x = _v212
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v213
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v205.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
            buff.write(val4.vertex_indices.tostring())
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v205.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.mesh_poses:
          _v214 = val3.position
          _x = _v214
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v215
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v205.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.planes:
          buff.write(val3.coef.tostring())
        length = len(_v205.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.plane_poses:
          _v216 = val3.position
          _x = _v216
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v217
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v205.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val3))
        length = len(_v205.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v205.subframe_poses:
          _v218 = val3.position
          _x = _v218
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(_v220.joint_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v220.joint_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v238.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v238.id = str[start:end]
        _v244 = _v238.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v244.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v244.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v238.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v238.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v238.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v238.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v238.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v238.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v251 = val3.position
          _x = _v251
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v238.subframe_poses.append(val3)
        start = end
        end += 1
        (_v238.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
...
class ManageTrajectory(object):
  ...
  _md5sum = '8bbcc0419524a57ce5c9b97a0e79e131'
