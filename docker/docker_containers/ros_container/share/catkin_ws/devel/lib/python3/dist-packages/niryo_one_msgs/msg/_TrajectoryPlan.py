...
"""autogenerated by genpy from niryo_one_msgs/TrajectoryPlan.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryPlan(genpy.Message):
  _md5sum = "a69e9552414597bf02f85da9ac7872e3"
  _type = "niryo_one_msgs/TrajectoryPlan"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """moveit_msgs/RobotState trajectory_start
string group_name
...
duration time_from_start
"""
  __slots__ = ['trajectory_start','group_name','trajectory']
  _slot_types = ['moveit_msgs/RobotState','string','moveit_msgs/RobotTrajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory_start,group_name,trajectory
    ...
    """
    if args or kwds:
      super(TrajectoryPlan, self).__init__(*args, **kwds)
