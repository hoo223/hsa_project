...
"""autogenerated by genpy from niryo_one_msgs/RobotMoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class RobotMoveActionResult(genpy.Message):
  _md5sum = "03fc587ef5064c57c83646823ac1e676"
  _type = "niryo_one_msgs/RobotMoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','niryo_one_msgs/RobotMoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobotMoveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = niryo_one_msgs.msg.RobotMoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = niryo_one_msgs.msg.RobotMoveResult()
