...
"""autogenerated by genpy from niryo_one_msgs/JoystickJointsActionResult.msg. Do not edit."""
import codecs
import sys
...
class JoystickJointsActionResult(genpy.Message):
  _md5sum = "e513ff94a9b5a65937aa859bf470b093"
  _type = "niryo_one_msgs/JoystickJointsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','niryo_one_msgs/JoystickJointsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JoystickJointsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = niryo_one_msgs.msg.JoystickJointsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = niryo_one_msgs.msg.JoystickJointsResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.has_succeeded,) = _get_struct_i().unpack(str[start:end])
      return self
