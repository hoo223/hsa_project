...
class JoystickJointsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JoystickJointsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JoystickJointsActionFeedback(null);
    ...
    data.feedback = JoystickJointsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JoystickJointsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = JoystickJointsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new JoystickJointsFeedback()
    }
...
module.exports = JoystickJointsActionFeedback;
