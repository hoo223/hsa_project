...
class SequenceActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SequenceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SequenceGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SequenceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SequenceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SequenceGoal()
    }
...
module.exports = SequenceActionGoal;
