...
class GetTrajectoryListRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetTrajectoryListRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetTrajectoryListRequest
    let len;
    let data = new GetTrajectoryListRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetTrajectoryListRequest(null);
    return resolved;
    }
};

class GetTrajectoryListResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetTrajectoryListResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetTrajectoryListResponse
    let len;
    let data = new GetTrajectoryListResponse(null);
  ...
  static messageDefinition() {
    // Returns full string definition for message
    return `
    niryo_one_msgs/Trajectory[] trajectories
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetTrajectoryListResponse(null);
...
module.exports = {
  Request: GetTrajectoryListRequest,
  Response: GetTrajectoryListResponse,
  md5sum() { return 'fe12a752ed8b8c5c7c779c1a34e6f2cb'; },
  datatype() { return 'niryo_one_msgs/GetTrajectoryList'; }
};
