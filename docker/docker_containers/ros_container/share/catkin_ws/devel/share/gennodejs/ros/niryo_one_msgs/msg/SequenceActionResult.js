...
class SequenceActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SequenceResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SequenceResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SequenceActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SequenceResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SequenceResult()
    }
...
module.exports = SequenceActionResult;
