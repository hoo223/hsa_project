...
class RobotMoveActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RobotMoveFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobotMoveActionFeedback(null);
    ...
    data.feedback = RobotMoveFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotMoveActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RobotMoveFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RobotMoveFeedback()
    }
...
module.exports = RobotMoveActionFeedback;
