...
let RobotMoveCommand = require('../msg/RobotMoveCommand.js');
...
class RobotMoveRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RobotMoveCommand.serialize(obj.cmd, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.cmd = RobotMoveCommand.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += RobotMoveCommand.getMessageSize(object.cmd);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cmd !== undefined) {
      resolved.cmd = RobotMoveCommand.Resolve(msg.cmd)
    }
    else {
      resolved.cmd = new RobotMoveCommand()
    }
...
module.exports = {
  ...
  md5sum() { return 'e9ab9373b04a9ce28afa8fdf7f5d39cd'; },
  datatype() { return 'niryo_one_msgs/RobotMove'; }
};
