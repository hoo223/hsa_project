...
class GetCalibrationCamRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCalibrationCamRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCalibrationCamRequest
    let len;
    let data = new GetCalibrationCamRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCalibrationCamRequest(null);
...
class GetCalibrationCamResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.is_set = null;
      ...
      if (initObj.hasOwnProperty('is_set')) {
        this.is_set = initObj.is_set
      }
      else {
        this.is_set = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCalibrationCamResponse
    // Serialize message field [is_set]
    bufferOffset = _serializer.bool(obj.is_set, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCalibrationCamResponse
    let len;
    let data = new GetCalibrationCamResponse(null);
    // Deserialize message field [is_set]
    data.is_set = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCalibrationCamResponse(null);
    if (msg.is_set !== undefined) {
      resolved.is_set = msg.is_set;
    }
    else {
      resolved.is_set = false
    }
...
module.exports = {
  Request: GetCalibrationCamRequest,
  Response: GetCalibrationCamResponse,
  md5sum() { return '474d4f7e9dcc435511068469b05fa0bb'; },
  datatype() { return 'niryo_one_msgs/GetCalibrationCam'; }
};
