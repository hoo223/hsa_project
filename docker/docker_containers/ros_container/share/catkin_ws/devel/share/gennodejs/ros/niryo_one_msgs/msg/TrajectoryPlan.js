...
class TrajectoryPlan {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('trajectory_start')) {
        ...
        this.trajectory_start = new moveit_msgs.msg.RobotState();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TrajectoryPlan
    // Serialize message field [trajectory_start]
    bufferOffset = moveit_msgs.msg.RobotState.serialize(obj.trajectory_start, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TrajectoryPlan
    let len;
    let data = new TrajectoryPlan(null);
    // Deserialize message field [trajectory_start]
    data.trajectory_start = moveit_msgs.msg.RobotState.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += moveit_msgs.msg.RobotState.getMessageSize(object.trajectory_start);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryPlan(null);
    if (msg.trajectory_start !== undefined) {
      resolved.trajectory_start = moveit_msgs.msg.RobotState.Resolve(msg.trajectory_start)
    }
    else {
      resolved.trajectory_start = new moveit_msgs.msg.RobotState()
    }
