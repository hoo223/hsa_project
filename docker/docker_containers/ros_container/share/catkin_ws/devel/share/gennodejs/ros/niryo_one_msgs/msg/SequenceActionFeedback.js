...
class SequenceActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SequenceFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SequenceActionFeedback(null);
    ...
    data.feedback = SequenceFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SequenceActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SequenceFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SequenceFeedback()
    }
...
module.exports = SequenceActionFeedback;
