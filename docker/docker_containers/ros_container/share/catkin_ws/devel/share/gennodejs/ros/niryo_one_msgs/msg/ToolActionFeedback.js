...
class ToolActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ToolFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ToolActionFeedback(null);
    ...
    data.feedback = ToolFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ToolActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ToolFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ToolFeedback()
    }
...
module.exports = ToolActionFeedback;
