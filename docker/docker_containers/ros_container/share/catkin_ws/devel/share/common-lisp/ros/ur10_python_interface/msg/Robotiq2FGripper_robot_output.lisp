...
(cl:defmethod cl:initialize-instance :after ((m <Robotiq2FGripper_robot_output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Robotiq2FGripper_robot_output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur10_python_interface-msg:<Robotiq2FGripper_robot_output> is deprecated: use ur10_python_interface-msg:Robotiq2FGripper_robot_output instead.")))

(cl:ensure-generic-function 'rACT-val :lambda-list '(m))
(cl:defmethod rACT-val ((m <Robotiq2FGripper_robot_output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:rACT-val is deprecated.  Use ur10_python_interface-msg:rACT instead.")
  (rACT m))

(cl:ensure-generic-function 'rGTO-val :lambda-list '(m))
(cl:defmethod rGTO-val ((m <Robotiq2FGripper_robot_output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:rGTO-val is deprecated.  Use ur10_python_interface-msg:rGTO instead.")
  (rGTO m))

(cl:ensure-generic-function 'rATR-val :lambda-list '(m))
(cl:defmethod rATR-val ((m <Robotiq2FGripper_robot_output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:rATR-val is deprecated.  Use ur10_python_interface-msg:rATR instead.")
  (rATR m))

(cl:ensure-generic-function 'rPR-val :lambda-list '(m))
(cl:defmethod rPR-val ((m <Robotiq2FGripper_robot_output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:rPR-val is deprecated.  Use ur10_python_interface-msg:rPR instead.")
  (rPR m))

(cl:ensure-generic-function 'rSP-val :lambda-list '(m))
(cl:defmethod rSP-val ((m <Robotiq2FGripper_robot_output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:rSP-val is deprecated.  Use ur10_python_interface-msg:rSP instead.")
  (rSP m))

(cl:ensure-generic-function 'rFR-val :lambda-list '(m))
(cl:defmethod rFR-val ((m <Robotiq2FGripper_robot_output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:rFR-val is deprecated.  Use ur10_python_interface-msg:rFR instead.")
  (rFR m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Robotiq2FGripper_robot_output>)))
  ...
  "ur10_python_interface/Robotiq2FGripper_robot_output")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Robotiq2FGripper_robot_output)))
  "Returns string type for a message object of type 'Robotiq2FGripper_robot_output"
  "ur10_python_interface/Robotiq2FGripper_robot_output")
