...
(cl:defmethod cl:initialize-instance :after ((m <Robotiq2FGripper_robot_input>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Robotiq2FGripper_robot_input)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur10_python_interface-msg:<Robotiq2FGripper_robot_input> is deprecated: use ur10_python_interface-msg:Robotiq2FGripper_robot_input instead.")))

(cl:ensure-generic-function 'gACT-val :lambda-list '(m))
(cl:defmethod gACT-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gACT-val is deprecated.  Use ur10_python_interface-msg:gACT instead.")
  (gACT m))

(cl:ensure-generic-function 'gGTO-val :lambda-list '(m))
(cl:defmethod gGTO-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gGTO-val is deprecated.  Use ur10_python_interface-msg:gGTO instead.")
  (gGTO m))

(cl:ensure-generic-function 'gSTA-val :lambda-list '(m))
(cl:defmethod gSTA-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gSTA-val is deprecated.  Use ur10_python_interface-msg:gSTA instead.")
  (gSTA m))

(cl:ensure-generic-function 'gOBJ-val :lambda-list '(m))
(cl:defmethod gOBJ-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gOBJ-val is deprecated.  Use ur10_python_interface-msg:gOBJ instead.")
  (gOBJ m))

(cl:ensure-generic-function 'gFLT-val :lambda-list '(m))
(cl:defmethod gFLT-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gFLT-val is deprecated.  Use ur10_python_interface-msg:gFLT instead.")
  (gFLT m))

(cl:ensure-generic-function 'gPR-val :lambda-list '(m))
(cl:defmethod gPR-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gPR-val is deprecated.  Use ur10_python_interface-msg:gPR instead.")
  (gPR m))

(cl:ensure-generic-function 'gPO-val :lambda-list '(m))
(cl:defmethod gPO-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gPO-val is deprecated.  Use ur10_python_interface-msg:gPO instead.")
  (gPO m))

(cl:ensure-generic-function 'gCU-val :lambda-list '(m))
(cl:defmethod gCU-val ((m <Robotiq2FGripper_robot_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10_python_interface-msg:gCU-val is deprecated.  Use ur10_python_interface-msg:gCU instead.")
  (gCU m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Robotiq2FGripper_robot_input>)))
  ...
  "ur10_python_interface/Robotiq2FGripper_robot_input")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Robotiq2FGripper_robot_input)))
  "Returns string type for a message object of type 'Robotiq2FGripper_robot_input"
  "ur10_python_interface/Robotiq2FGripper_robot_input")
