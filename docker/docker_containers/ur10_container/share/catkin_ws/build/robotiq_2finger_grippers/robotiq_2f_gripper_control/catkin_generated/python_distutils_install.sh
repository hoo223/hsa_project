...
echo_and_run cd "/root/share/catkin_ws/src/robotiq_2finger_grippers/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/share/catkin_ws/src/robotiq_2finger_grippers/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/root/share/catkin_ws/build/robotiq_2finger_grippers/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
