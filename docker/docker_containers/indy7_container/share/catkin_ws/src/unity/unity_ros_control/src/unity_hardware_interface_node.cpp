...
int main(int argc, char** argv)
{
  ...
  // Subscriber
  // ros::Subscriber unity_indy7_state_sub = nh.subscribe<sensor_msgs::JointState>("unity_indy7_joint_states", 100, boost::bind(&UnityUR10::stateCallback, &ur10, _1));
  ...
  controller_manager::ControllerManager cm(&indy7, nh);
