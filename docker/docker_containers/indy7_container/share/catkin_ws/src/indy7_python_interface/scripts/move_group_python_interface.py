...
from indy7_python_interface.srv import SolveIk
...
class MoveGroupPythonInteface(object):
  ...
  def __init__(self, base_controller, velocity_controller, arg_group_name="indy7", gym=False, verbose=False, prefix=''):
