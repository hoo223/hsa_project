...
(cl:in-package indy7_python_interface-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Ellipsoid3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ellipsoid3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name indy7_python_interface-msg:<Ellipsoid3> is deprecated: use indy7_python_interface-msg:Ellipsoid3 instead.")))

(cl:ensure-generic-function 's-val :lambda-list '(m))
(cl:defmethod s-val ((m <Ellipsoid3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader indy7_python_interface-msg:s-val is deprecated.  Use indy7_python_interface-msg:s instead.")
  (s m))

(cl:ensure-generic-function 'u1-val :lambda-list '(m))
(cl:defmethod u1-val ((m <Ellipsoid3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader indy7_python_interface-msg:u1-val is deprecated.  Use indy7_python_interface-msg:u1 instead.")
  (u1 m))

(cl:ensure-generic-function 'u2-val :lambda-list '(m))
(cl:defmethod u2-val ((m <Ellipsoid3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader indy7_python_interface-msg:u2-val is deprecated.  Use indy7_python_interface-msg:u2 instead.")
  (u2 m))

(cl:ensure-generic-function 'u3-val :lambda-list '(m))
(cl:defmethod u3-val ((m <Ellipsoid3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader indy7_python_interface-msg:u3-val is deprecated.  Use indy7_python_interface-msg:u3 instead.")
  (u3 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Ellipsoid3>)))
  ...
  "indy7_python_interface/Ellipsoid3")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Ellipsoid3)))
  "Returns string type for a message object of type 'Ellipsoid3"
  "indy7_python_interface/Ellipsoid3")
