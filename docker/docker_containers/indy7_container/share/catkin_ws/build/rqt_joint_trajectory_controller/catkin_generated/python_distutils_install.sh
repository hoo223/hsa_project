...
echo_and_run cd "/root/share/catkin_ws/src/rqt_joint_trajectory_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/root/share/catkin_ws/src/rqt_joint_trajectory_controller/setup.py" \
     \
    build --build-base "/root/share/catkin_ws/build/rqt_joint_trajectory_controller" \
    install \
    --root="${DESTDIR-/}" \
