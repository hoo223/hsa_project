...
for j in range(1):
    for i in range(50):
        pose.append(np.load('/root/share/catkin_ws/src/ur10_python_interface/scripts/data/actual_pose'+str(i+1)+'_init'+str(j+1)+'.npy'))
        vel.append(np.load('/root/share/catkin_ws/src/ur10_python_interface/scripts/data/actual_vel'+str(i+1)+'_init'+str(j+1)+'.npy'))
        acc.append(np.load('/root/share/catkin_ws/src/ur10_python_interface/scripts/data/joint_space_acc'+str(i+1)+'_init'+str(j+1)+'.npy'))
        desired_pose.append(np.load('/root/share/catkin_ws/src/ur10_python_interface/scripts/data/joint_space_pose'+str(i+1)+'_init'+str(j+1)+'.npy'))
        desired_vel.append(np.load('/root/share/catkin_ws/src/ur10_python_interface/scripts/data/joint_space_vel'+str(i+1)+'_init'+str(j+1)+'.npy'))
...
print(pose[0])
print(vel[0])
print(desired_pose[0])
print(desired_vel[0])
print(next_pose[0])
print(next_vel[0])
#plt.plot(pose)
#plt.plow(vel)
#plt.plot(desired_pose,'r')
#plt.plot(desired_vel,'k')
#plt.show()
...
for j in range(1):
    ...
    for i in range(epoch):
        ...
        if i % 100 == 0:
            ...
            print(next_vel[10])
            print('')
            print(j+1, i, _loss,__loss, _loss1+_loss2+_loss3+_loss4+_loss5+_loss6+_loss7+_loss8+_loss9+_loss10+_loss11+_loss12+_loss13, end-now)
    saver.save(sess,'/root/share/catkin_ws/src/ur10_python_interface/scripts/dp_model.ckpt')
     '''
