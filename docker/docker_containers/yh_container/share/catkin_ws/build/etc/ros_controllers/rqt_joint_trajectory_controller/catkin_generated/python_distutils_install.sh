...
echo_and_run cd "/root/share/catkin_ws/src/etc/ros_controllers/rqt_joint_trajectory_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/share/catkin_ws/src/etc/ros_controllers/rqt_joint_trajectory_controller/setup.py" \
     \
    build --build-base "/root/share/catkin_ws/build/etc/ros_controllers/rqt_joint_trajectory_controller" \
    install \
    --root="${DESTDIR-/}" \
