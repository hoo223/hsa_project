...
echo_and_run cd "/root/share/catkin_ws/src/etc/rqt_controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/share/catkin_ws/src/etc/rqt_controller_manager/setup.py" \
     \
    build --build-base "/root/share/catkin_ws/build/etc/rqt_controller_manager" \
    install \
    --root="${DESTDIR-/}" \
