...
echo_and_run cd "/root/share/catkin_ws/src/etc/cob/cob_command_tools/generic_throttle"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/share/catkin_ws/src/etc/cob/cob_command_tools/generic_throttle/setup.py" \
     \
    build --build-base "/root/share/catkin_ws/build/etc/cob/cob_command_tools/generic_throttle" \
    install \
    --root="${DESTDIR-/}" \
