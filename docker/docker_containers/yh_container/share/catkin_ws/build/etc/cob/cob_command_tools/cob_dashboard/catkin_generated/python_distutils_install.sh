...
echo_and_run cd "/root/share/catkin_ws/src/etc/cob/cob_command_tools/cob_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/share/catkin_ws/src/etc/cob/cob_command_tools/cob_dashboard/setup.py" \
     \
    build --build-base "/root/share/catkin_ws/build/etc/cob/cob_command_tools/cob_dashboard" \
    install \
    --root="${DESTDIR-/}" \
