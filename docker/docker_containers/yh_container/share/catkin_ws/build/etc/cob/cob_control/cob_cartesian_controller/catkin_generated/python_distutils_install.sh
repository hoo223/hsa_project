...
echo_and_run cd "/root/share/catkin_ws/src/etc/cob/cob_control/cob_cartesian_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/share/catkin_ws/src/etc/cob/cob_control/cob_cartesian_controller/setup.py" \
     \
    build --build-base "/root/share/catkin_ws/build/etc/cob/cob_control/cob_cartesian_controller" \
    install \
    --root="${DESTDIR-/}" \
